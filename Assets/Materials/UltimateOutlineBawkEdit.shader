...
Shader "Outlined/UltimateOutline"
{
	Properties
	{
		...
		_FirstOutlineColor("Outline 1 color", Color) = (1,0,0,0.5)
		_FirstOutlineWidth("Outlines 1 width", Range(0.0, 2.0)) = 0.15
		[Toggle] _enable1("Outline 1 Enable ",float) = 1

		_SecondOutlineColor("Outline 2 color", Color) = (0,0,1,1)
		_SecondOutlineWidth("Outlines 2 width", Range(0.0, 2.0)) = 0.025
		[Toggle] _enable2("Outline 2 Enable ",float) = 1
